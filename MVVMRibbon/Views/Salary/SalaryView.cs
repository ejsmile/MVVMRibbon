...
{
    [DevExpress.Utils.MVVM.UI.ViewType("SalaryCollectionView")]    
    public partial class SalaryView : DevExpress.XtraEditors.XtraUserControl
    {
        public SalaryView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            var fluentAPI = mvvmContext1.OfType<SalaryCollectionViewModel>();
            ...
            fluentAPI.WithEvent<ColumnView, FocusedRowObjectChangedEventArgs>(gridView1, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as DataModels.Salary,
            ...
            fluentAPI.WithEvent<DevExpress.Data.SelectionChangedEventArgs>(gridView1, "SelectionChanged")
                .SetBinding(x => x.Selection, e => GetSelectedSalary());
        }

        IEnumerable<MVVMRibbon.DataModels.Salary> GetSelectedSalary()
        {
            return gridView1.GetSelectedRows().Select(r => gridView1.GetRow(r) as MVVMRibbon.DataModels.Salary);
        }
    }
}
